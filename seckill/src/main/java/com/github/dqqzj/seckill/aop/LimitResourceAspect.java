...
import com.github.dqqzj.seckill.exception.RrException;
import com.github.dqqzj.seckill.utils.IpUtils;
...
public class LimitResourceAspect {
	...
	@Pointcut("@annotation(com.github.dqqzj.seckill.aop.LimitResource)")
