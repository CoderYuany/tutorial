...
public class SeckillQueue {
    ...
    /** 用于多线程间下单的队列 */
    static BlockingQueue<SeckillRequest> blockingQueue = new LinkedBlockingQueue<>(QUEUE_MAX_SIZE);
     ...
     */
    public Boolean produce(SeckillRequest seckillRequest) throws InterruptedException {
    	return blockingQueue.offer(seckillRequest);
    }
    /**
     * 消费出队
     ...
     */
    public SeckillRequest consume() throws InterruptedException {
