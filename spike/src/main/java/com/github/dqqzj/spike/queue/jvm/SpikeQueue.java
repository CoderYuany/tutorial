...
public class SpikeQueue {
    ...
    /** 用于多线程间下单的队列 */
    static BlockingQueue<SpikeRequest> blockingQueue = new LinkedBlockingQueue<>(QUEUE_MAX_SIZE);
     ...
     * @return 单例队列
     */
    public static SpikeQueue getMailQueue(){
     ...
     */
    public Boolean produce(SpikeRequest spikeRequest) throws InterruptedException {
    	return blockingQueue.offer(spikeRequest);
    }
    /**
     * 消费出队
     ...
     */
    public SpikeRequest consume() throws InterruptedException {
